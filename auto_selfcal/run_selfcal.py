...
def run_selfcal(selfcal_library, selfcal_plan, target, band, n_ants, \
        ...
        gaincalibrator_dict={}, allow_gain_interpolation=False, guess_scan_combine=False, aca_use_nfmask=False,debug=False,spectral_solution_fraction=0.3,use_wproject=True):
